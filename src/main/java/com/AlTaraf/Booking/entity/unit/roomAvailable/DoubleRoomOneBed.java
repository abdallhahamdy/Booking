...
//
//@Entity
//@Table(name = "double_room_one_bed")
//public class DoubleRoomOneBed {
//
//    @Id
...
//    private int number;
//
//    public DoubleRoomOneBed() {
//    }
//
//    public DoubleRoomOneBed(Long id, RoomAvailable roomAvailable, int newPrice, int oldPrice, int number) {
//        this.id = id;
