...
//
//@Entity
//@Table(name = "double_room_two_beds")
//public class DoubleRoomTwoBeds {
//
//    @Id
...
//    private int number;
//
//    public DoubleRoomTwoBeds() {
//    }
//
//    public DoubleRoomTwoBeds(Long id, RoomAvailable roomAvailable, int newPrice, int oldPrice, int number) {
//        this.id = id;
